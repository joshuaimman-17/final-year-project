...
export const ToastProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    return (
        <ToastContext.Provider value={{ showToast }}>
            {children}
            <div className="position-fixed bottom-0 start-50 translate-middle-x pb-4 mb-5 z-max d-flex flex-column gap-2" style={{ width: '400px', maxWidth: '90vw', zIndex: 1060 }}>
                {toasts.map(toast => (
                    <div 
                        key={toast.id} 
